...
public class RecommendationRepository {
    ...
    public List<Recommendation> findAll() {
        return em.createQuery("from Recommendation", Recommendation.class).getResultList();
    }

    // found recommendation of a product
    public List<Recommendation> findByIdProd(String productId)
            throws EntityNotFoundException, SolrServerException, IOException {
    ...
    public List<Recommendation> findByIdTwoProd(String productId1, String productId2)
            throws EntityNotFoundException, SolrServerException, IOException {
        SolrQuery query = new SolrQuery();
        query.setQuery("(productId1:" + productId1 + " AND productId2:" + productId2 + ") OR (productId1:" + productId2
                + " AND productId2:" + productId1 + ")");
    ...
    @Transactional
    public Recommendation insert(Recommendation r)
